...
const referralProgramActionLocale: Record<"fr" | "en" | "nl" | "kiny", ReferralProgramActionCopy> = {
  fr: {
    ...
    clientEmailOptional: "E-mail (facultatif si un téléphone est indiqué)",
    clientPhoneOptional: "Téléphone ou WhatsApp (facultatif si un e-mail est indiqué)",
    clientContactRequired: "Indiquez au moins un moyen de contacter le client : e-mail ou téléphone/WhatsApp.",
    needOptional: "Décrivez le besoin (facultatif)",
  ...
  en: {
    ...
    clientEmailOptional: "Email (optional if a phone number is provided)",
    clientPhoneOptional: "Phone or WhatsApp (optional if an email is provided)",
    clientContactRequired: "Provide at least one way to contact the client: email or phone/WhatsApp.",
    needOptional: "Describe the need (optional)",
  ...
  nl: {
    ...
    clientEmailOptional: "E-mail (optioneel als een telefoonnummer is opgegeven)",
    clientPhoneOptional: "Telefoon of WhatsApp (optioneel als een e-mail is opgegeven)",
    clientContactRequired: "Geef minstens één contactmogelijkheid op: e-mail of telefoon/WhatsApp.",
    needOptional: "Beschrijf de behoefte (optioneel)",
  ...
  kiny: {
    ...
    clientEmailOptional: "Email (si ngombwa niba telefone yatanzwe)",
    clientPhoneOptional: "Telefone cyangwa WhatsApp (si ngombwa niba email yatanzwe)",
    clientContactRequired: "Tanga nibura uburyo bumwe bwo kuvugisha umukiliya: email cyangwa telefone/WhatsApp.",
    needOptional: "Sobanura ibyo bakeneye (si ngombwa)",
