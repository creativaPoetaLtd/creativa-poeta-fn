...
const referralProgramLocale: Record<"fr" | "en" | "nl" | "kiny", ReferralProgramCopy> = {
  fr: {
    ...
    steps: [
      { title: "Vous faites l’introduction", text: "Présentez une entreprise dont vous connaissez réellement le besoin et qui accepte cette mise en relation." },
    ...
    form: {
      ...
      network: "", terms: "J’accepte les conditions du programme et je confirme avoir au moins 18 ans.", marketing: "Je souhaite recevoir les actualités et conseils du programme (facultatif).", send: "Envoyer ma demande", sending: "Envoi…",
  ...
  en: {
    ...
    form: { name: "Full name", email: "Email address", country: "Country", profile: "Your profile", program: "Participation type", website: "LinkedIn or website (optional)", network: "", terms: "I accept the program terms and confirm that I am at least 18.", marketing: "I would like to receive program news and tips (optional).", send: "Send my application", sending: "Sending…", profiles: ["Individual", "Student", "Freelancer", "Consultant", "Sales professional", "Agency", "Other"], referral: "Occasional introducer", business: "Commercial partner", success: "Your application has been submitted.", error: "Could not submit your application." },
  ...
  nl: {
    ...
    howTitle: "Wat houdt dit programma in?", howLead: "Het beloont mensen die Creativa Poeta met nieuwe klanten verbinden. U hoeft niets te verkopen of uit te voeren: een echte en eerlijke introductie volstaat.", steps: [{ title: "U maakt de introductie", text: "Stel ons voor aan een bedrijf waarvan u de behoefte echt kent en dat instemt met het contact." }, { title: "Creativa Poeta neemt over", text: "Ons team begrijpt de behoefte, maakt het aanbod en levert de afgesproken dienst." }, { title: "U ontvangt uw beloning", text: "Na aanvaarding van het project en ontvangst van de in aanmerking komende betaling wordt uw beloning berekend en betaald." }],
  ...
  kiny: {
    ...
    howTitle: "Iyi porogaramu ikora ite?", howLead: "Ihemba abantu bahuza Creativa Poeta n’abakiliya bashya. Ntugomba kugurisha cyangwa gukora project: introduction nyayo kandi y’ukuri irahagije.", steps: [{ title: "Uduhuza n’umukiliya", text: "Utumenyesha business uzi neza icyo ikeneye kandi yemeye ko tuyivugisha." }, { title: "Creativa Poeta ikomeza akazi", text: "Team yacu yumva ibyo bakeneye, igategura offer kandi igakora service bumvikanyeho." }, { title: "Uhabwa igihembo", text: "Project imaze kwemerwa n’amafaranga yemerewe amaze kwakirwa, igihembo cyawe kirabarwa kikishyurwa." }],
