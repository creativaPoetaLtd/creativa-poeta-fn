...
const permissionOptions: Array<{ key: AdminPermission; label: string; group: string }> = [
  ...
  { key: "referrals:read", label: "Referral program read", group: "Referrals" },
  { key: "referrals:manage", label: "Referral leads manage", group: "Referrals" },
  { key: "partners:approve", label: "Partner applications approve", group: "Referrals" },
  { key: "rewards:read", label: "Referral rewards read", group: "Referrals" },
  { key: "rewards:approve", label: "Referral rewards approve", group: "Referrals" },
  { key: "rewards:pay", label: "Referral rewards mark paid", group: "Referrals" },
  { key: "referrals:settings", label: "Referral program settings", group: "Referrals" },
  { key: "contacts:read", label: "Contact inbox read", group: "Messages" },
  { key: "contacts:reply", label: "Contact inbox reply", group: "Messages" },
  { key: "whatsapp:read", label: "WhatsApp inbox read", group: "Messages" },
  { key: "whatsapp:reply", label: "WhatsApp inbox reply", group: "Messages" },
  { key: "whatsapp:manage", label: "WhatsApp settings and templates", group: "Messages" },
