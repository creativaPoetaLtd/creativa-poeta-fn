...
const About = () => {
  ...
  const backgrounds = [{ image: image8 }, { image: image2 }];
  ...
  return (
    ...
    >
      ...
      >
        <div className="laptop:mt-[0%]  laptop:py-0 desktop:py-0 phone:py-0 tablet:py-0 iphone:py-0 ipod:py-0 xs:py-20 tablet:mt-[0%] laptop:space-y-10 space-y-5 mt-[0rem]">
          <div className="flex justify-evenly flex-col laptop:space-y-10 space-y-5 laptop:w-[50%] w-[90%] tablet:w-[70%] mx-auto">
            <div className="flex justify-evenly flex-col laptop:space-y-5 space-x-3">
              <div className="flex justify-evenly">
                <h1 className="laptop:text-4xl tablet:text-3xl text-2xl font-bold text-slate-800 mx-0 animate-fade-in animate-bounce underline-offset-6">
                  {AboutLocale[lang].title1}
                </h1>
              </div>
            </div>
          ...
          <div className="flex justify-evenly laptop:px-40 px-4">
            <h1 className="laptop:text-2xl leading-relaxed tablet:text-2xl text-slate-800 mx-0 animate-fade-in animate-bounce underline-offset-6 text-center justify-evenly">
              {AboutLocale[lang].description}
            </h1>
          </div>
        </div>
        <div className="very-top laptop:h-[13%] tablet:h-[13%] phone:h-[10%] h-[8%] laptop:w-[10%] w-[35%] absolute laptop:right-20 right-11 top-0 border-r-2 border-neutral-100"></div>
      ...
      <a
        href="/contact"
        className="contact us bg-black text-white font-bold py-2 px-4 rounded-md absolute bottom-0 left-0 desktop:mb-28 laptop:mb-28 ipod:mb-56 phone:mb-24 tablet:mb-56 xs:mb-16 laptop:ml-40 desktop:ml-40 ml-3 border-2 border-[#FFE533]"
      >
