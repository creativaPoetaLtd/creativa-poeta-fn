...
const homeRefonteCopy = {
  fr: {
    about: {
      ...
      title: "Un souffle créatif, une main technique, une touche poétique.",
      body: "Creativa Poeta donne vie aux idées. Nous mêlons design, mots, sites web, contenus, visibilité et intelligence artificielle pour créer des présences qui se voient, se comprennent et se retiennent. Votre créativité est notre passion.",
    },
    pillars: [
      { icon: MessageCircle, title: "Une voix", body: "Des mots qui portent votre idée avec clarté, rythme et intention." },
      { icon: Target, title: "Une image", body: "Des visuels, logos et supports qui donnent une forme visible à votre univers." },
    ...
    problem: {
      ...
      body: "Aujourd'hui, un client peut vous chercher sur Google, demander une recommandation ? un assistant vocal, regarder Google Maps, comparer des avis, visiter Instagram ou poser une question ? une IA. Si vos informations sont dispersees, contradictoires ou difficiles à comprendre, vous pouvez être invisible au moment precis ou le client a besoin de vous.",
      alt: "Presence invisible ou visible au bon moment selon la cohérence des informations",
    },
    localCta: {
      first: "Quelle agence peut refaire mon site pour être visible dans Google et les moteurs IA ?",
    ...
    channels: {
      ...
      body: "Site, Google, maps et réseaux sociaux travaillent ensemble pour rendre votre entreprise plus facile à trouver.",
    },
    ai: {
      eyebrow: "Voix et IA",
      title: "Vos clients ne tapent plus seulement des mots. Ils posent des questions.",
      body: "Nous vous aidons à devenir une réponse claire dans les recherches vocales, les assistants et les moteurs conversationnels.",
    },
    trust: {
      eyebrow: "Confiance",
      title: "Plus de clarté. Plus de coherence. Plus de visibilité.",
      body: "Quand vos informations sont exactes et à jour partout, les clients et les moteurs modernes vous comprennent mieux.",
    ...
    creative: {
      eyebrow: "Votre créativité",
      title: "Nos services créatifs restent au coeur de Creativa Poeta.",
      body: "Design graphique, r?daction, contenus, présentations, documents, vid?os, publications et supports professionnels : nous transformons vos idées en cr?ations visibles, utiles et mémorables.",
      alt: "Services creatifs de Creativa Poeta : design, r?daction, contenus, documents, présentations et visibilité",
    },
    final: {
      title: "Votre créativité, notre passion.",
      body: "Que vous soyez entrepreneur, cr?ateur de contenu, entreprise ou particulier, nous sommes l? pour donner vie à vos idées, renforcer votre présence en ligne et susciter l'engagement de votre public.",
      primary: "Demarrer un projet",
      secondary: "Parler a Creativa Poeta",
    },
    channelCards: {
      site: ["Votre site", "La base claire qui explique votre offre."],
      google: ["Google", "être trouvé au moment où le client cherche."],
      local: ["Profils locaux", "Des informations cohérentes là où les clients regardent."],
      social: ["R?seaux sociaux", "Des preuves vivantes, des avis, des r?alisations."],
    ...
    aiCards: {
      ...
      voiceSearch: ["Recherche vocale", "Votre entreprise doit pouvoir être la réponse simple et utile."],
      recommendation: ["Recommandations IA", "Les outils comme ChatGPT doivent comprendre pourquoi vous recommander."],
      conversation: ["Conversation", "Votre présence doit être assez claire pour être cit?e dans une réponse."],
    },
  },
  en: {
    about: {
    ...
    creative: {
      ...
      body: "Graphic design, writing, content, présentations, documents, vid?os, posts and professional supports: we turn your ideas into visible, useful and memorable creations.",
      alt: "Creativa Poeta creative services: design, writing, content, documents, présentations and visibility",
    },
    final: {
  ...
  nl: {
    ...
    final: {
      ...
      body: "Of u nu ondernemer, content creator, bedrijf of particulier bent, wij helpen uw ideeen tot leven brengen, uw online aanwezigheid versterken en uw publiek bêtrekken.",
