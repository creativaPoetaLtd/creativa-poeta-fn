const Term = () => {
    return (
        <div className='p-12'>
            ...
            <p className='mt-[.5rem] text-xl'>Last updated: 2023-11-27</p>
            <p className='mt-[3rem] text-xl font-bold'>Introduction</p>
            <p className='mt-[.2rem] text-xl'>Welcome to Creativa-poeta (“Company”, “we”, “our”, “us”)!</p>
            ...
            <p className='mt-[3rem] text-xl font-bold'>Content</p>
            <div className='mt-[3rem]'>
                <p>Content found on or through this Service are the property of Creativa-poeta or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
            </div>
            <p className='mt-[3rem] text-xl font-bold'>Prohibited Uses</p>
            <div className='mt-[3rem]'>
                ...
                <ol className="list-decimal ml-6 mt-4">
                    ...
                    <li> Use any manual process to monitor or copy any of the material on Service or for any other unauthorised purpose without our prior written consent.
                    </li>
                    ...
                    <li>Attempt to gain unauthorised access to, interfere with, damage, or disrupt any parts of Service, the server on which Service is stored, or any server, computer, or database connected to Service.
                    </li>
                    <li>Attack Service via a denial-of-service attack or a distributed denial-of-service attack.
                    </li>
                    <li>Take any action that may damage or falsify Company ratings.
                    </li>
                    <li>Otherwise attempt to interfere with the proper working of Service.
                    </li>
                </ol>
            </div>
            <p className='mt-[3rem] text-xl font-bold'> No Use By Minors</p>
            <div className='mt-[3rem]'>
                <p>Service is intended only for access and use by individuals at least eighteen (18) years old. By accessing or using Service, you warrant and represent that you are at least eighteen (18) years of age and with the full authority, right, and capacity to enter into this agreement and abide by all of the terms and conditions of Terms. If you are not at least eighteen (18) years old, you are prohibited from both the access and usage of Service</p>
            </div>
            <p className='mt-[3rem] text-xl font-bold'>Intellectual Property</p>
            <div className='mt-[3rem]'>
                <p>Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Creativa-poeta and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of Creativa-poeta.
                </p>
            </div>
            <p className='mt-[3rem] text-xl font-bold'> Copyright Policy</p>
            <div className='mt-[3rem]'>
            ...
            <p className='mt-[3rem] text-xl font-bold'>DMCA Notice and Procedure for Copyright Infringement Claims</p>
            <div className='mt-[3rem]'>
                <p>You may submit a notification pursuant to the Digital Millennium Copyright Act (DMCA) by providing our Copyright Agent with the following information in writing (see 17 U.S.C 512(c)(3) for further detail): </p>
            </div>
            <div className='mt-[3rem]'>
                <ol className="list-decimal ml-6 mt-4">
                    <li> an electronic or physical signature of the person authorised to act on behalf of the owner of the copyright’s interest;
                    </li>
                    ...
                    <li>a statement by you that you have a good faith belief that the disputed use is not authorised by the copyright owner, its agent, or the law;
                    </li>
                </ol>
            </div>
            ...
            <div className='mt-[3rem]'>
                <p>Our Service may contain links to third party web sites or services that are not owned or controlled by Creativa-poeta.</p>
            </div>
            <p>Creativa-poeta has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>
        </div>
    )
}
