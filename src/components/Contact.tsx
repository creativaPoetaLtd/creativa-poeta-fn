          ...
          <div className="container flex  flex-1 px-6 py-12 mx-auto">
            <div className="flex w-full justify-between desktop:flex-row laptop:flex-row tablet:flex-col flex-col">
              <div className="text-white w-full my-auto desktop:w-[50%] laptop:w-1/2 tablet:w-full">
                ...
                <p className="max-w-xl mt-6">{contactLocale[lang]?.intro}</p>
                ...
                <button className="px-8 py-3 mt-6 text-sm font-bold tracking-wide text-black capitalize transition-colors duration-300 transform bg-yellow-500 rounded-md hover:bg-yellow-400 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                  {contactLocale[lang]?.cta}{" "}
                  <FaArrowRight className="inline-block ml-2 text-xl " />
                </button>

                <div className="mt-6 md:mt-8">
                  <h3 className="text-white-300 ">
                    {" "}
                    {contactLocale[lang]?.socials}{" "}
                  </h3>
              ...
              <div className="mt-8 w-full desktop:w-[46%] laptop:w-[46%] tablet:w-full">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-black shadow-2xl rounded-xl ">
                  ...
                  <form className="contact-form mt-6" onSubmit={handleSubmit}>
                    ...
                    >
                      {!isLoading
                        ? `${contactLocale[lang]?.action}`
                        : `${contactLocale[lang]?.wait}`}
                    </button>
                  </form>
                </div>
              </div>
