    ...
    return (
        <>
            <section className="min-h-screen bg-cover " style={{ backgroundImage: `url(${image8})` }}>
                ...
                <div className="flex  min-h-screen bg-black/60">
                    <div className="container flex  flex-1 px-6 py-12 mx-auto">
                        <div className="flex w-full justify-between desktop:flex-row laptop:flex-row tablet:flex-col flex-col">
                            <div className="text-white w-full my-auto desktop:w-[50%] laptop:w-1/2 tablet:w-full">
                                <h1 className="text-5xl font-bold capitalize lg:text-3xl">Creativa Poeta</h1>
                                ...
                                <div className="mt-6 md:mt-8">
                                    <h3 className="text-white-300 ">Follow us</h3>
                                ...
                                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-black shadow-2xl rounded-xl ">
                                    ...
                                    <form className="mt-6">
                                        <div className="flex-1">
                                            ...
                                            <input type="text" placeholder="John Doe" className="block w-full px-5 py-3 mt-2 text-white bg-black border border-yellow-200 rounded-md " />
                                        </div>

                                        <div className="flex-1 mt-6">
                                            <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Email address</label>
                                            <input type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-black border border-yellow-200 rounded-md " />
                                        </div>

                                        <div className="w-full mt-6">
                                            <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Message</label>
                                            <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-black border border-yellow-200 rounded-md md:h-48 " placeholder="Message"></textarea>
                                        </div>
