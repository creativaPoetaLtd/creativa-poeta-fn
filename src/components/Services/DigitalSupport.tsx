    ...
    <div className="relative min-h-screen bg-white flex justify-center items-center">
      ...
      <section className="relative w-[90%] max-w-screen-lg mx-auto py-16 px-8 md:px-24 flex flex-col md:flex-row items-center justify-between z-10">
        ...
        <div className="md:w-2/3 space-y-6 text-white">
          ...
          <img src={tech} alt="" className="w-[8rem] h-[8rem]" />
          <h1 className="text-4xl ml-4 font-bold">
              Digital Support
              <br />
              <span className="text-blue-600">
                {" "}
                Navigate the Digital World with Confidence and Ease
              </span>
            </h1>
          </div>

          <p className="text-2xl leading-relaxed w-3/4">
            Our free digital support service is here to help you master new
            technologies without stress. Whether it’s online shopping, managing
            administrative tasks, or connecting on social media, our experienced
            team provides step-by-step guidance to ensure a smooth and secure
            digital experience. We’re committed to giving you the confidence and
            peace of mind needed to navigate today’s digital landscape
            effortlessly. Unlock the full potential of technology and simplify
            your digital life with our dedicated support—absolutely free.
          </p>
        </div>
