...
const testimonials = [
  {
    quote: "Their advertising designs brought our brand to life. The campaigns were not only visually stunning but also incredibly effective in attracting new customers.",
    client: "Sophia Carter",
    role: "Marketing Director, Elite Apparel",
    image: "/avatar1.jpg",
  },
  {
    quote: "Working with their team was seamless. Their ad designs captured our vision perfectly, helping us achieve a 40% increase in sales during our seasonal campaign.",
    client: "Liam Jackson",
    role: "Owner, Bloom & Beyond",
    image: "/avatar1.jpg",
  },
  {
    quote: "The creativity and precision they put into every design are unmatched. Our nonprofit's awareness campaign exceeded expectations, thanks to their expertise.",
    client: "Isabella Ramirez",
    role: "Program Manager, GreenFuture Alliance",
    image: "/avatar1.jpg",
  },
  {
    quote: "Their innovative designs and out-of-the-box thinking were exactly what we needed for our product launch. The ads were a huge hit with our audience.",
    client: "Ethan Walker",
    role: "CEO, PureTech Solutions",
    image: "/avatar1.jpg",
  },
  {
    quote: "The team went above and beyond to deliver ads that truly resonated with our audience. Their designs helped us stand out in a crowded market.",
...
const faqs = [
  {
    ...
    answer: "We deliver ad designs in a variety of formats, including images (JPG, PNG), videos (MP4), and platform-specific formats optimized for social media, print, or digital use.",
  },
  {
    question: "Can you create ads for multiple social media platforms?",
    answer: "Yes, we specialize in creating versatile ad designs tailored to platforms such as Facebook, Instagram, LinkedIn, Twitter, and others, ensuring each design aligns with platform-specific requirements.",
  },
  {
    question: "How long does it take to design a campaign from start to finish?",
    answer: "The timeline depends on the complexity and scope of the campaign. Typically, ad designs are completed within 1-3 weeks, including feedback and revisions.",
  },
  {
    question: "Do you offer consultation on advertising strategy along with design?",
    answer: "Yes, we provide strategic consultation to help you plan your advertising campaigns effectively. This includes audience targeting, platform selection, and messaging strategies.",
  },
  {
    question: "Can you handle both digital and print ad design?",
    answer: "Absolutely! We design ads for both digital platforms like social media and websites, as well as traditional print media such as magazines, brochures, and billboards.",
  },
  {
    question: "Do you offer revisions for the ad designs?",
    answer: "Yes, we include a set number of revisions in our design process to ensure the final ads meet your expectations and align with your brand identity.",
  },
  {
    question: "Can you design ads that align with my existing brand guidelines?",
    answer: "Yes, we work closely with your brand guidelines to ensure all ad designs are consistent with your brand’s tone, colors, and style.",
  },
  {
    question: "Do you provide motion graphics or animated ads?",
    answer: "Yes, we create engaging motion graphics and animated ads to capture attention and enhance the impact of your campaigns.",
  },
  {
    question: "What industries do you cater to for advertising design?",
    answer: "We have experience working with a wide range of industries, including retail, e-commerce, nonprofits, technology, healthcare, and more. Our designs are tailored to suit your specific business goals.",
  },
  {
    question: "How do I get started with your advertising design services?",
    answer: "Getting started is easy! Contact us to discuss your campaign goals, and we’ll create a customized plan and timeline for your advertising needs.",
  },
];
  ...
  <div className="w-full laptop:w-1/2 space-y-6 text-white flex flex-col items-center md:items-start md:justify-between px-4 md:px-8 py-5">
    <div className="flex items-center mb-4">
      ...
      Advertising Design <br />
        <span className="text-[#EEBA2B] text-2xl">Transforming ideas into compelling campaigns that captivate and inspire action  </span>
      </h1>
    </div>
    <p className="text-xl leading-relaxed text-start md:text-left">
    Effective advertising design goes beyond aesthetics—it communicates, persuades, and inspires action. Our team crafts visually engaging ad campaigns that highlight your brand's message, capture attention, and resonate with your audience. From digital ads to print materials, we create advertisements that elevate your brand’s visibility and drive results across all media platforms.    </p>
...
<section className="advertising-design-section relative w-full md:w-[95%] max-w-screen-lg mx-auto mt-12 p-6 gap-24 text-white rounded-lg mb-12 flex flex-col md:flex-row z-10">
  <div className="visual-container hidden laptop:flex md:w-1/2 h-full">
    <img src="/AdDesgnn.jpg" alt="Advertising Design Skills" className="w-[95%] h-[95%] rounded-md" />
  </div>
  <div className="content-container w-full md:w-full laptop:w-1/2 flex flex-col justify-center">
    <h2 className="text-3xl font-bold text-[#EEBA2B] mb-6">Our Advertising Design Skills</h2>
    <ul className="space-y-4 text-lg p-4 h-full flex flex-col justify-between">
      <li>
        <strong className="text-2xl">- Visual Branding: </strong> Develop consistent and compelling visual identities that resonate with your target audience and elevate your brand’s presence.
      </li>
      <li>
        <strong className="text-2xl">- Campaign Design: </strong> Create impactful and strategic advertising campaigns tailored for digital and print platforms to maximize reach and engagement.
      </li>
      <li>
        <strong className="text-2xl">- Graphic Design Expertise: </strong> Deliver high-quality visuals including banners, posters, flyers, and digital ads that captivate and inspire action.
      </li>
      <li>
        <strong className="text-2xl">- Motion Graphics and Animation: </strong> Enhance campaigns with dynamic animations and motion graphics that bring your message to life.
      </li>
      <li>
        <strong className="text-2xl">- Platform-Specific Ad Design: </strong> Customize designs for platforms like Google Ads, Facebook, Instagram, and LinkedIn to optimize performance and ROI.
      </li>
    </ul>
  </div>
</section>
...
<section className="why-choose-us-section text-white w-full md:w-[95%] max-w-screen-lg mx-auto mt-12 p-8 rounded-lg flex flex-col z-10 bg-gradient-to-br from-gray-800 to-black shadow-lg">
  ...
  <div className="flex flex-col md:flex-row w-full items-center">
    ...
    <div className="w-full laptop:w-1/2 flex flex-col justify-center text-lg space-y-6 p-6 md:p-8">
      ...
      "Our advertising design team combines creativity with strategic insights to create campaigns that not only look great but drive results. With a focus on brand consistency, target audience alignment, and visual impact, we deliver ads that capture attention and inspire action." </blockquote>
      <ul className="space-y-6 pl-4 list-disc text-base md:text-lg">
        ...
        <li>In-depth understanding of advertising trends and audience behavior</li>
...
Who Can Benefit from Our Advertising Design Services?  </h2>

  <p className="text-lg text-center mb-8">
  Our Advertising Design Service is tailored to create visually compelling and effective advertisements that drive results. Whether you’re looking to strengthen your market presence, launch a product, or promote a cause, our team of design experts is here to help.
  </p>
  ...
  <div className="grid md:grid-cols-2 grid-cols-1 laptop:grid-cols-4 gap-8 text-black">
    <div className="shadow-lg rounded-md bg-white p-6 flex flex-col items-center text-center">
      ...
      <h3 className="text-xl font-semibold mb-2">Businesses and Brands </h3>
      <p className="md:w-[70%]">
      Wanting to enhance their market presence through professional advertising.     </p>
    </div>
    ...
    <div className="shadow-lg rounded-md bg-white p-6 flex flex-col items-center text-center">
      ...
      <p className="  md:w-[70%]">
      Aiming to launch products or services with memorable ad campaigns.    </p>
    </div>
    ...
    <img
      ...
      <p className="md:w-[70%]">
      Seeking to raise awareness and support for their cause.    </p>
    </div>
    ...
    <div className="shadow-lg rounded-md bg-white p-6 flex flex-col items-center text-center">
      ...
      />
      <h3 className="text-xl font-semibold mb-2">Retailers and E-commerce Brands  </h3>
      <p className="md:w-[70%]">
      Needing creative ads to boost sales and promote special offers.     </p>
    </div>
  </div>
</section>
...
<section className="design-process-section w-full md:w-[95%] max-w-screen-lg mx-auto mt-12 p-8 rounded-lg text-white shadow-lg relative z-10 bg-gradient-to-br from-gray-800 to-black">
  ...
  <div className="relative flex flex-col laptop:flex-row items-center space-y-16">
    ...
    <div className="flex items-start space-x-6 lg:space-x-12 lg:flex-row flex-col lg:items-center">
      <div className="lg:order-2 order-1">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-white"> We discuss your goals, target audience, and the message you want to convey.</p>
        </div>
      </div>
    </div>
    {/* Connector Line */}
    ...
    <div className="flex items-start space-x-6 lg:space-x-12 lg:flex-row-reverse flex-col lg:items-center">
      ...
      <div className="text-center lg:text-left">
        <h3 className="text-2xl font-semibold mb-2 text-[#EEBA2B]">2. Concept Development</h3>
        <p className="text-white">Our team brainstorms and develops ad concepts that align with your brand.</p>
      </div>
    </div>
    {/* Connector Line */}
    <div className="laptop:w-72 laptop:h-1 w-1 h-16 bg-[#EEBA2B]"></div>
    ...
    {/* Step 3 - Left */}
    <div className="flex items-start space-x-6 lg:space-x-12 lg:flex-row flex-col lg:items-center">
      <img src="/ad33.jpg" alt="Production Icon" className="w-36 h-36 mx-auto lg:mx-0 rounded-full shadow-lg mb-4 lg:mb-0" />
      <div className="text-center lg:text-left">
        <h3 className="text-2xl font-semibold mb-2 text-[#EEBA2B]">3. Design and Creation </h3>
        <p className="text-white">Visual design, video production, or motion graphics tailored to your campaign.</p>
      </div>
    </div>
    {/* Connector Line */}
    <div className="laptop:w-72 laptop:h-1 w-1 h-16 bg-[#EEBA2B]"></div>
    ...
    <div className="flex items-start space-x-6 lg:space-x-12 lg:flex-row-reverse flex-col lg:items-center">
      ...
      <div className="text-center lg:text-left">
        <h3 className="text-2xl font-semibold mb-2 text-[#EEBA2B]">4.	Feedback and Revisions </h3>
        <p className="text-white">We refine the design based on your feedback to ensure your satisfaction.</p>
      </div>
    </div>
    {/* Connector Line */}
    <div className="laptop:w-72 laptop:h-1 w-1 h-16 bg-[#EEBA2B]"></div>
    ...
    <div className="flex items-start space-x-6 lg:space-x-12 lg:flex-row flex-col lg:items-center">
      ...
      <div className="text-center lg:text-left">
        ...
        <p className="text-white">We deliver ready-to-publish files optimized for the platforms of your choice.</p>
      </div>
    </div>
  </div>
</section>
...
<section className="portfolio-section w-full md:w-[95%] max-w-screen-lg mx-auto mt-12 p-8 text-center  text-white z-10">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 laptop:grid-cols-3 gap-6">
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/proeject1.jpg" alt="Portfolio Item" className="w-[100%] h-full transform group-hover:scale-105 transition duration-300 object-cover" />
    ...
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/project2.jpg" alt="Portfolio Item" className="w-full h-full transform group-hover:scale-105 transition duration-300 object-cover" />
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
    ...
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/project3.jpg" alt="Portfolio Item" className="w-full h-full transform group-hover:scale-105 transition duration-300 object-cover" />
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
    ...
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/project4.webp" alt="Portfolio Item" className="w-full h-full transform group-hover:scale-105 transition duration-300 object-cover" />
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
    ...
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/project5.jpg" alt="Portfolio Item" className="w-full h-full transform group-hover:scale-105 transition duration-300 object-cover" />
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
    ...
    <div className="relative group overflow-hidden rounded-lg shadow-lg bg-white">
      <img src="/project6.jpg" alt="Portfolio Item" className="w-full h-full transform group-hover:scale-105 transition duration-300 object-cover" />
      <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
...
<section className="contact-section w-full md:w-[95%] py-16 px-6 text-white text-center flex flex-col items-center z-10">
  <h2 className="text-3xl font-semibold mb-4">Ready to Make Your Brand Stand Out?</h2>
  <p className="text-lg mb-8 px-6 max-w-2xl mx-auto">
  Ready to captivate your audience with powerful advertising? Get in touch with us to launch a campaign that drives results!
  </p>
  ...
  <Link to="/start-project">
    ...
    >
Start Your Ad Campaign Today!    </button>
  </Link>
</section>
    ...
    <section className="visual-elements w-full  md:w-[95%] rounded-md mb-4 bg-white py-16 px-4 text-gray-800 flex flex-col items-center z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mx-auto">
        ...
        <div className="skill-item text-center">
          ...
          <p>Unique and creative designs that capture attention and inspire action.</p>
        </div>
        ...
        <div className="skill-item text-center">
          ...
          <p> Strategic campaigns that align with your brand and target audience.</p>
        </div>
        ...
        <div className="skill-item text-center">
          ...
          <p> Motion graphics and animations that enhance the impact of your ads.</p>
        </div>
        ...
        <div className="col-span-full">
          ...
          <div className="carousel flex overflow-x-scroll space-x-4">
            <img src="/project6.jpg" alt="Project 1" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
            <img src="/project5.jpg" alt="Project 2" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
            <img src="/project4.webp" alt="Project 3" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
            <img src="/project3.jpg" alt="Project 3" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
            <img src="/project2.jpg" alt="Project 3" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
            <img src="/proeject1.jpg" alt="Project 3" className="w-64 h-48 object-cover rounded-lg shadow-lg" />
          </div>
        </div>
