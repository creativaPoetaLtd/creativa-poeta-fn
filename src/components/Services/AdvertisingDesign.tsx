    ...
    <div className="relative min-h-screen bg-white flex justify-center items-center">
      ...
      <section className="relative w-[90%] max-w-screen-lg mx-auto py-16 px-8 md:px-24 flex flex-col md:flex-row items-center justify-between z-10">
        ...
        <div className="md:w-2/3 space-y-6 text-white">
          ...
          <img src={pub} alt="" className="w-[8rem] h-[8rem]" />
          <h1 className="text-4xl ml-4 font-bold">
              Advertising Design
              <br />
              <span className="text-blue-600">
                {" "}
                Transforming Ideas into Impactful Campaigns
              </span>
            </h1>
          </div>

          <p className="text-2xl leading-relaxed w-3/4">
            Our advertising design service brings your message to life through
            visually striking and engaging campaigns that resonate with your
            audience. From concept to execution, we craft both visual and
            audiovisual advertisements that not only capture attention but also
            amplify your brand’s presence across all communication channels.
            With a focus on inspiring interest and encouraging action, our
            campaigns are designed to make a lasting impact and drive results.
            Let’s turn your ideas into powerful, action-oriented ads that
            elevate your brand’s visibility and influence.
          </p>
        </div>
