...
const copy = {
  fr: {
    ...
    text: "Nous utilisons des cookies necessaires au fonctionnement du site. Avec votre accord, nous pouvons aussi utiliser des cookies de preferences, d'analyse et de marketing.",
    ...
    analyticsText: "Mesure d'audience pour ameliorer le site.",
    marketingText: "Campagnes, remarketing ou contenus personnalises.",
    decline: "Refuser",
    accept: "Accepter",
    customize: "Personnaliser",
    save: "Enregistrer mes choix",
    back: "Retour",
    more: "Confidentialite et cookies",
  },
  en: {
